defmodule Phoenix.Controller.ControllerTest do
  ...
  describe "send_download/3" do
    ...
    test "sends file for download with custom :content_type and :charset" do
      ...
      assert get_resp_header(conn, "content-type") == ["application/json; charset=utf8"]
      assert conn.resp_body == "world"
    end
  ...
  test "__layout__ returns the layout modoule based on controller module" do
    assert Phoenix.Controller.__layout__(UserController, []) == LayoutView
